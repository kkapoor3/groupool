...
class _AddProfileState extends State<AddProfile>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
        appBar: AppBar(title:Center(child: Text('Enter Details')),backgroundColor: Colors.brown[900],),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 15),
                Text(
                  'Selected time: ${_time.format(context)}', style: simpleTextStyle(),
                ),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(primary: Colors.brown[800]),
                ...
                SizedBox(height: 8),
                Text(
                  'Selected time: ${_time2.format(context)}',style: simpleTextStyle()
                ),
                // SizedBox(
                //   height: 16,
                // ),
